...
class Connect(object):
    @staticmethod    
    def get_connection():
        return MongoClient("mongodb://user_readwrite:JCFF2m4OFEd5nmTT@cluster-open-shard-00-00-kzzlc.mongodb.net:2801,cluster-open-shard-00-01-kzzlc.mongodb.net:2801,cluster-open-shard-00-02-kzzlc.mongodb.net:2801/test?replicaSet=cluster-open-shard-0&authSource=admin&ssl=true")
...
path_folder = "C:/Users/parinppatel/Documents/Pythonscripts/MongoDB/data"
kaggle.api.dataset_download_files('parinppatel/english-premier-league-player-data-20182019', 
                                  path = path_folder, 
                                  unzip = True)
